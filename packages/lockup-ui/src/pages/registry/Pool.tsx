...
export default function Pool() {
	...
	const { pool, poolTokenMint, poolVault, megaPool, megaPoolTokenMint, megaPoolVaults } = useSelector((state: StoreState) => {
		return {
	...
	return (
		<div> TODO: POOL VISUALIZATION + CREATE/REDEEM </div>
	);
}
...
class PoolPrices {
	...
	basket(sptAmount: BN, roundUp: boolean): Basket {
		return {
			quantities: [this.poolVault.amount
											.mul(sptAmount)
